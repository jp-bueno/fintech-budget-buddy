...
const SEED_USER_ID = "user_2lUOOueOHavvWz4LLsMUVKXQ6G0";
...
import { EachDayOfIntervalOptions, format } from "date-fns";
...
const generateTransactionsForDay = (day: Date) => {
  ...
  for (let i = 0; i < numTransactions; i++) {
    ...
    const isExpense = Math.random() > 0.6; // 60% chance de ser uma expense
